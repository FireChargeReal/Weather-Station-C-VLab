...
#define LPP_PM25 140 // 2 bytes, 0.1°C signed
#define LPP_PM10 141 // 2 bytes, 0.1°C signed
...
#define LPP_PM25_SIZE 4 // 2 bytes, 0.1°C signed
#define LPP_PM10_SIZE 4 // 2 bytes, 0.1°C signed
...
public:
    ...
    uint8_t addPM25(uint8_t channel, float PM);
    uint8_t addPM10(uint8_t channel, float PM);
